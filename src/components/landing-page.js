        ...
        <div className="intro-content">
          <div className="col">
            <article>
              ...
              <p>Dan is het handig <span className="color-red">als</span> je kunt <span className="color-blue">programmeren</span>! Met de programmeer-tool <span className="color-purple">CT-3000</span> oefen je een aantal belangrijke programmeer-principes, zoals <span className="color-blue">‘IF-THEN’</span>. Dus, bedenk iets slims <span className="color-red">en</span> programmeer het zelf!</p>
              <Link to={'/nl/tool'} className="fat-link"><span>Aan de slag met <em>CT-3000</em></span></Link>
            </article>
            <article>
              <h2>Het thema Smart Life</h2>
              <p>De programmeer-tool CT-3000 hoort bij het thema Smart Life, over computional thinking en programmeren.
              ...
              <a href="https://smart-life.blink.nl/bwonderbouw/7-8/smart-life" className="fat-link"><span>Naar de <em>lessen</em></span></a>
            </article>
          </div>
        </div>
      </div>
